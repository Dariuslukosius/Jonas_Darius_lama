...
import lamaLocalLogoWhite from "@/assets/brands/lamalocal-logo-white.svg";
...
const partnerLogos = [
  { src: agrija, alt: "Agrija", className: "h-14 md:h-16" },
  { src: alfadenta, alt: "Alfadenta Dental", className: "h-[4.5rem] md:h-20" },
  { src: amadenta, alt: "Amadenta Dental", className: "h-14 md:h-16" },
  { src: autoglass, alt: "Autoglass.lt", className: "h-12 md:h-14" },
  { src: romtesa, alt: "Romtesa", className: "h-14 md:h-16" },
  { src: hanseTrailer, alt: "Hanse Trailer", className: "h-14 md:h-16" },
  { src: joMiTattoo, alt: "Jo Mi Tattoo", className: "h-[4.5rem] md:h-20 invert mix-blend-multiply" },
  { src: visuSventuTattoo, alt: "Visu Sventu Tattoo", className: "h-20 md:h-[5.25rem]" },
  { src: kurtasService, alt: "Kurtas Service", className: "h-12 md:h-14" },
  { src: gpDentistry, alt: "GP Dentistry", className: "h-16 md:h-[4.5rem]" },
  { src: britannia, alt: "Britannia Accountancy Services", className: "h-20 md:h-24 mix-blend-multiply" },
] as const;
          ...
          <div className="relative rounded-[2rem] border border-emerald-400/35 bg-[#10271f] p-8 shadow-[0_22px_55px_rgba(34,197,94,0.18)]">
            ...
            <div className="relative">
              <h3 className="mb-8 flex items-center gap-3 text-2xl font-bold text-white">
                ...
                <img src={lamaLocalLogoWhite} alt="LamaLocal" className="h-14 w-auto md:h-16" />
              </h3>
              <ul className="space-y-4">
                {comparisonFeatures.map((feature) => (
                  <li key={feature} className="flex items-center gap-4">
          ...
          {partnerLogos.map((logo, index) => (
            ...
            >
              <img
                ...
                alt={logo.alt}
                loading="lazy"
                className={`w-auto object-contain ${logo.className ?? "h-14 md:h-16"}`}
              />
            </motion.div>
          ))}
        </div>
