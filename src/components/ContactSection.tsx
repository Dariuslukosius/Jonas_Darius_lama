...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61586058251633&locale=lt_LT",
    icon: Facebook,
  },
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              <div className="rounded-[1.75rem] border border-white/10 bg-[rgba(8,20,17,0.58)] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-sm">
                ...
                <a
                  ...
                  className="mt-8 flex items-center gap-4 text-lg text-white/85 transition-colors hover:text-white xl:text-xl"
                >
                  <Mail className="h-7 w-7 shrink-0" />
                  <span className="whitespace-nowrap">info@lamalocal.com</span>
                </a>
              </div>
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-[rgba(8,20,17,0.58)] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-sm">
                ...
                <div className="mt-8 space-y-3">
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 text-base text-white/85 transition-colors hover:text-white md:text-lg"
                  >
                    <Phone className="h-7 w-7 shrink-0" />
                    <span className="whitespace-nowrap">EN: +44 7598 555448</span>
                  </a>
                </div>
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-[rgba(8,20,17,0.58)] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-sm">
                ...
                <div className="mt-8 space-y-2 text-xl text-white/85">
                  ...
                  <img
                    src={lamaLocalLogoWhite}
                    alt="Lama Local logo"
                    className="pt-4 h-16 w-auto object-contain"
                  />
                </div>
              </div>
            </div>
