...
const clientReviews = [
  ...
  },
  {
    ...
    avatar: avatarGiedre,
    text: "For a long time, our business was difficult to find on Google. After starting with llamamaps, everything changed and within 3 months we reached TOP 5 positions for our main keywords.",
